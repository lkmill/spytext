...
Spytext.prototype = {
	...
	actions: {
		...
		newline: function() {
			...
			var block = rng.startContainer.nodeType === 1 && rng.startContainer.matches('LI, P, H1, H3, H4, H5, H6') ? rng.startContainer : $(rng.startContainer).closest('LI, P, H1, H2, H3, H4, H5, H6', this.currentField.element)[0];
